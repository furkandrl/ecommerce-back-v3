package com.dereli.ecommercebackv3.constants;

public class DereliCoreConstants {

    public static final String DERELI_STORE_CODE = "DERELI";
    public static final String DERELI_STORE_NAME = "Dereli Store";
